...
public abstract class BeanUtils {
	...
	/**
	 * Return the primary constructor of the provided class.（返回所提供类的主构造函数）
	 * For Kotlin classes, this returns the Java constructor corresponding to the Kotlin
	 * primary constructor (as defined in the Kotlin specification).
	 * Otherwise, in particular for non-Kotlin
